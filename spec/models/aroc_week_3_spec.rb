...
# ----------------------
  ...
  it '16. returns the names of users who ordered one specific item' do
    ...
    users = User.joins(:items).where('item_id = ?', @item_8.id).order(:name).pluck(:name) # Alexander
    # ------------------------------------------------------------
  ...
  it '17. returns the name of items associated with a specific order' do
    ...
    names = Items.joins(:orders).where('order_id = ?', Order.last.id).pluck(:name) #Alexander
    # ------------------------------------------------------------
  ...
  it '18. returns the names of items for a users order' do
    ...
    # items_for_user_3_third_order = @user_3.orders[2].items.pluck(:name) # Alexander's
    # ------------------------------------------------------------
